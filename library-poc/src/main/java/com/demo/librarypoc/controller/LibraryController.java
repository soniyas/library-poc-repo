...
public class LibraryController {
    ...
    public ResponseEntity<Integer> updateBook(@RequestBody BookInfo bookInfo) {
        ...
        return new ResponseEntity<>(libraryService.updateBook(bookInfo), HttpStatus.OK);
    }
    ...
    @PostMapping("/search")
    @ApiOperation(value = "Searches the books on any of the attributes in the Library.")
    ...
    @PostMapping("/import")
    @ApiOperation(value = "Imports the books into the Library.")
